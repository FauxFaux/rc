...
cargo-up() { nice cargo update && nice cargo build --all && nice cargo check && nice cargo build --release --all && nice cargo test --all }
...
export PYTHONPATH=$PYTHONPATH:$HOME/lib/python3.5/site-packages/:$HOME/lib/python
